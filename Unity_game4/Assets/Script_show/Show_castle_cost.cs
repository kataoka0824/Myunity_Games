...
public class Show_castle_cost : MonoBehaviour
{
    ...
    void Update()
    {
        if (field_script.turn == 1)
        {
            ...
            power_text.text = "1P城壁コスト:" + state_1p_script.cost_castle.ToString();
        }
        if (field_script.turn == 2)
        {
            Text power_text = text_obj.GetComponent<Text>();
            power_text.text = "2P城壁コスト:" + state_2p_script.cost_castle.ToString();
        }
    }
}
