...
public class Show_castle_hp : MonoBehaviour
{
    ...
    void Update()
    {
        if (field_script.turn == 1)
        {
            ...
            power_text.text = "1P城壁HP:" + state_1p_script.castle_hp.ToString();
        }
        if (field_script.turn == 2)
        {
            Text power_text = text_obj.GetComponent<Text>();
            power_text.text = "2P城壁HP:" + state_2p_script.castle_hp.ToString();
        }
    }
}
