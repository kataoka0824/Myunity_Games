...
public class Make_1p : MonoBehaviour
{
    ...
    public Player1 player_script;
    public State_1p state_1p_script;
    public Make_aria_1p make_script;
    ...
    void Update()
    {
        ...
        if (field_script.turn == 1 && Input.GetKeyDown(KeyCode.C))
        {
            if(make_script.jud_obj == 0 && state_1p_script.cost >= state_1p_script.cost_castle)
            {
        ...
        if (field_script.turn == 1 && Input.GetKeyDown(KeyCode.T))
        {
            if (make_script.jud_obj == 0 && state_1p_script.cost >= state_1p_script.cost_trap)
            {
        ...
        if (field_script.turn == 1 && Input.GetKeyDown(KeyCode.B))
        {
            if (make_script.jud_obj == 0 && state_1p_script.cost >= state_1p_script.cost_trap + state_1p_script.cost_castle && state_1p_script.trap_castle > 0)
            {
