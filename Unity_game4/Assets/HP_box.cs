...
public class HP_box : MonoBehaviour
{
    ...
    void OnTriggerEnter(Collider collider)
    {
        if (collider.gameObject.tag == "bullet_2p")
        {
            ...
            p2_script = p2_obj.GetComponent<State_2p>();
            hp -= p2_script.power;
            p2_script.castle_hp_s += p2_script.power;
            audioSource.PlayOneShot(damage);
        ...
        if (collider.gameObject.tag == "bullet_1p")
        {
            ...
            p1_script = p1_obj.GetComponent<State_1p>();
            hp -= p1_script.power;
            p1_script.castle_hp_s += p1_script.power;
            audioSource.PlayOneShot(damage);
            GameObject obj = Instantiate(hit_eff,
                        transform.position,
                        transform.rotation);
        ...
        if (collider.gameObject.tag == "explode_2p")
        {
            ...
            p2_script.castle_hp_s += p2_script.explode_power;
            audioSource.PlayOneShot(damage);
            GameObject obj = Instantiate(hit_eff,
                        transform.position,
                        transform.rotation);
        ...
        if (collider.gameObject.tag == "explode_1p")
        {
            ...
            p1_script.castle_hp_s += p1_script.explode_power;
            audioSource.PlayOneShot(damage);
            GameObject obj = Instantiate(hit_eff,
                        transform.position,
                        transform.rotation);
